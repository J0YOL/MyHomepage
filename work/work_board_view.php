			...
			<section class="sub_sections">
				...
				<div id="board_box">
					<?php
						...
						$new_hit = $hit + 1;
						$sql = "update work set hit=$new_hit where num=$num";   
				...
				<ul class="buttons">
					<li><input type="button" value="목록" onclick="location.href='work_board_list.php?page=<?=$page?>'"></input></li>
					<li><input type="button" value="수정" onclick="location.href='work_board_modify_form.php?num=<?=$num?>&page=<?=$page?>'"></input></li>
					<li><input type="button" value="삭제" onclick="location.href='/bbs/work_board_delete.php?num=<?=$num?>&page=<?=$page?>'"></input></li>
