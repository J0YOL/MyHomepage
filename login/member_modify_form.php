...
<head>
    ...
    <link rel="stylesheet" href="/css/login_modify.css?ver='1'"> 
    <script>
        function check_pw(){
...
<body>
    <div id="wrap">
        ...
        <div class="center">
            ...
            <input type="submit" value="저장하기" onclick="check_pw()"> 
            <input type="reset" value="취소하기" onclick="location.href='/index.php'">
