				...
				<li><input type="button" value="글쓰기" onclick="location.href='Visitor_board_form.php'"></input></li>
				   ...
				   <thead>
					...
					<tbody>
						...
						<tr>
                            <td><?=$number?></td>
                            <td><a href="Visitor_board_view.php?num=<?=$num?>&page=<?=$page?>"><?=$subject?></a></td>
                            <td><?=$name?></td>
                            <td><?=$file_image?></td>
                            <td><?=$regist_day?></td>
                            <td><?=$hit?></td>
				...
				<div id="page">
                    <ul>
                        ...
                        if($total_page>=2 && $page>=2){
                            $new_page=$page-1;
                            echo"<li id ='btn'><a href='Visitor_board_list.php?page=$new_page'>< 이전</a></li>";
                        }
                        else
                        ...
                        for($i=1;$i<=$total_page;$i++){
                            if($page==$i){
                                ...
                                echo"<li id='next_page'><a href='Visitor_board_list.php?page=$i'>$i</a></li>";
                            }
                        }
                        if($total_page>=2 && $page!=$total_page){
                            $new_page=$page+1;
                            echo"<li id=btn><a href='Visitor_board_list.php?page=$new_page'>다음 ></a></li>";
                        }
                        else
